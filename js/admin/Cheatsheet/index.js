var CHEATSHEET = {
    ...
    add: function() {
        ...
        $('<div/>').attr('id', CHEATSHEET.DLG_ID.substring(1)).Dialog({
            title: '添加快捷键', href: 'Cheatsheet/edit', width: 360,
    ...
    batch_add: function() {
        var self = this;
        $('<div/>').attr('id', CHEATSHEET.DLG_ID.substring(1)).Dialog({
            title: '批量添加快捷键', href: 'Cheatsheet/batch_add', width: 360,
    ...
    edit: function() {
        ...
        if (selected) {
            $('<div/>').attr('id', self.DLG_ID.substring(1)).Dialog({
                title: '编辑快捷键', href: 'Cheatsheet/edit', width: 360,
                buttonUrl: 'Api/Cheatsheet/edit', selected: selected,
                submitSuccessCallback: function() { $(self.DG_ID).Reload_Datagrid(); }
            });
