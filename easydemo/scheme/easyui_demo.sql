...
CREATE TABLE IF NOT EXISTS `z_auth_group` (
...
CREATE TABLE IF NOT EXISTS `z_auth_group_access` (
...
CREATE TABLE IF NOT EXISTS `z_cheatsheet` (
...
CREATE TABLE IF NOT EXISTS `z_log_info` (
...
(4, 1, 3, '管理区域', 'close_site', '关闭站点', 'js/admin/Site/close.js', 0, 'dialog', 'open', 0, '1'),
...
CREATE TABLE IF NOT EXISTS `z_menu_auth` (
...
(1, 'tt', 'e10adc3949ba59abbe56e057f20f883e', 0, 0, 'tt@tt.com', '2014-06-25', 86, 1421339957, 2130706433, 'default', 'user', 'pass'),
